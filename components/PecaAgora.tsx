...
import { Globe, MessageCircle, Bike, Clock3 } from "lucide-react";

const OPCOES = [
  { label: "Pelo cardápio online", icone: Globe, href: "/cardapio" },
  { label: "Pelo WhatsApp", icone: MessageCircle, href: `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER}` },
