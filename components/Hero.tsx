...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-[99vh] w-full items-center overflow-hidden bg-benvenuto-black pb-16 pt-28">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-benvenuto-black/60 via-benvenuto-black/15 to-transparent" />
      <div className="absolute inset-0 bg-gradient-to-r from-benvenuto-black/50 via-benvenuto-black/10 to-transparent" />
